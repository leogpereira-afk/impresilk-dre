...
function render(){
  ...
  const pages={inicio:renderInicio,caixa:renderCaixa,resultado:renderResultado,custos:renderCustos,detalhe:renderDetalhe,conferencia:renderConferencia,config:renderConfig,ajuda:renderAjuda};
...
function renderAjuda(){return [
 ...
 ['Onde está cada recurso','Produtos, serviços, pessoal, materiais, máquinas, frota, energia e água estão em Detalhamento. Os gráficos de entradas e saídas estão em Visão geral e Caixa. Despesas por mês, como energia e água, estão em Centros de custos. O demonstrativo para impressão está em Resultado. Backup e importação ficam em Sistemas e configurações.'],
