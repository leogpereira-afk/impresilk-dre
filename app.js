...
function wireContent(){
  ...
  on('legacyBackup',()=>download('dre-fila-anterior.json',localStorage.getItem('impresilk_dre_queue')));on('printReport',()=>exportarCFO({tipo:'executivo',periodo:state.periodo},$$('printReport')));on('backupBtn',exportarBackup);on('addMonthBtn',()=>$$('monthFileInput').click());on('restoreBtn',()=>$$('restoreInput').click());on('auditMubi',conferirMubi);on('originEvents',()=>mostrarEventos());
